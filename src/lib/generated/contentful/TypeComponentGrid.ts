...
export interface TypeComponentGridFields {
   ...
   * @localized false
   */
  mobileColumnsAmount: EntryFieldTypes.Symbol<
    "1" | "2" | "3" | "4" | "5" | "6"
  >;
  /**
   ...
   * @localized false
   */
  tabletColumnsAmount: EntryFieldTypes.Symbol<
    "1" | "2" | "3" | "4" | "5" | "6"
  >;
  /**
   ...
   * @localized false
   */
  desktopColumnsAmount: EntryFieldTypes.Symbol<
    "1" | "2" | "3" | "4" | "5" | "6" | "7" | "8"
  >;
  /**
   ...
   */
  gapX: EntryFieldTypes.Symbol<
    "None" | "lg" | "sm" | "xlg" | "xsm" | "xxlg" | "xxsm"
  >;
  /**
 ...
 * @version 25
 */
export type TypeComponentGridSkeleton = EntrySkeletonType<
 ...
 * @version 25
 */
export type TypeComponentGrid<
  Modifiers extends ChainModifiers,
  Locales extends LocaleCode,
> = Entry<TypeComponentGridSkeleton, Modifiers, Locales>;

export function isTypeComponentGrid<
  Modifiers extends ChainModifiers,
  Locales extends LocaleCode,
>(
  entry: Entry<EntrySkeletonType, Modifiers, Locales>,
): entry is TypeComponentGrid<Modifiers, Locales> {
